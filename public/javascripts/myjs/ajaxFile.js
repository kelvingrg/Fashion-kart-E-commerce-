    ...
    $.ajax({
        ...
        success: (response) => {
            if (response.updatepass) {
                ...
                swal("The password has been updated !", {icon: "success"})
            } else {
...
function cancelOrder(orderId) {
    ...
    swal({
        ...
        if (willDelete) {
            swal("The orfer has been Cancelled!", {icon: "success"})
            $.ajax({
        ...
        success: (response) => {
            if (response) {
                swal({
                    ...
                    text: " Clicking 'Ok' will Deactivate all the products under the Catagory "+cataName,
                    icon: "warning",
                    buttons: true,
                    dangerMode: true
                }).then((willDelete) => {
...
function addNewCatagoryOffer(catagory) {
    ...
    swal.fire({
        ...
        $.ajax({url: '/admin/addCatagoryOffer', data: {
                catagory
            }, method: 'post'})
    })

}
function applyCatagoryOffer() {
    event.preventDefault()

    let cataName = document.getElementById("cataName").value
    let offerPercentageEntered = document.getElementById("offerPercentage").value
    console.log('caliad', cataName, offerPercentageEntered);
    $.ajax({
        url: "/admin/applyCatagoryOffer",
        data: {
            cataName,
            offerPercentageEntered
        },
        method: 'post',
        success: (response) => {
...
function removeCatagoryOffer(cataName) {
    swal('rexhed at ajax')
    $.ajax({
        url: "/admin/removeCatagoryOffer",
        data: {
            cataName
        },
        method: 'post',
...
function approveRefund(orderId){
    swal({
      title: "Are you sure?",
      text: "Order moving to return and Will Initiate Refund ",
      icon: "warning",
      buttons: true,
      dangerMode: true
  }).then((willDelete) => {
      if (willDelete) {
  $.ajax({
    url:"/admin/approveRefund/"+orderId,
    method:'get',
    success:(response)=>{
        swal("amount refunded")
  ...
  function singleC(couponId){
    swal('reached at ajax')
    $.ajax({
        url:'/singleCouponHistory/'+couponId,
        method:'get'
    })
  }

  function setBannerActive(bannerId){
    $.ajax({
...
function deleteBanner(bannerId){
    $.ajax({
        ...
        method:'get',
        success:(response)=>{
            document.getElementById(bannerId).outerHTML=""
        }
    })
}
function deactivateProduct(prodId){
  swal("reached at ajax ")
    $.ajax({
        url:'/admin/deactivateProduct/'+prodId,
        method:'get',
        success:(response)=>{
     window.location.reload()
        }
...
function activateProduct(prodId){
    swal("reached at ajax ")
      $.ajax({
          url:'/admin/activateProduct/'+prodId,
          method:'get',
          success:(response)=>{
